# Tema 2 - Ejercicios de estructura secuencial (en JAVA)
...
## Ejercicio 5
Un vendedor recibe un sueldo base mas un 10% extra por comisión de sus ventas, el vendedor desea saber cuanto dinero obtendrá por concepto de comisiones por las tres ventas que realiza en el mes y el total que recibirá en el mes tomando en cuenta su sueldo base y comisiones. (El algoritmo leerá por teclado el sueldobase y las tres ventas).
